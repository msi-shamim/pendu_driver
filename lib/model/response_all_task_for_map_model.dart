...
//
//     final responseAllTaskForMap = responseAllTaskForMapFromMap(jsonString);

import 'dart:convert';

class ResponseAllTaskForMapModel {
  ResponseAllTaskForMapModel({
    this.status,
    this.message,
    this.allTaskList,
  });
  ...
  final List<AllTaskList> allTaskList;

  factory ResponseAllTaskForMapModel.fromJson(String str) =>
      ResponseAllTaskForMapModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory ResponseAllTaskForMapModel.fromMap(Map<String, dynamic> json) =>
      ResponseAllTaskForMapModel(
        status: json["status"] == null ? null : json["status"],
        message: json["message"] == null ? null : json["message"],
        allTaskList: json["data"] == null
            ? null
            : List<AllTaskList>.from(
                json["data"].map((x) => AllTaskList.fromMap(x))),
      );

  Map<String, dynamic> toMap() => {
        "status": status == null ? null : status,
        "message": message == null ? null : message,
        "data": allTaskList == null
            ? null
...
class AllTaskList {
  ...
  factory AllTaskList.fromJson(String str) =>
      AllTaskList.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory AllTaskList.fromMap(Map<String, dynamic> json) => AllTaskList(
