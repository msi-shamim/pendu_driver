...
class TaskTimeLineUtils extends StatefulWidget {
  int screenValue = 0;
  TaskTimeLineUtils({this.screenValue});
  @override
  _TaskTimeLineUtilsState createState() => _TaskTimeLineUtilsState();
}

class _TaskTimeLineUtilsState extends State<TaskTimeLineUtils> {
