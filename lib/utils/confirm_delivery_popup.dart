...
class ConfirmDeliveryPopUp extends StatefulWidget {
  @override
  _ConfirmDeliveryPopUpState createState() => _ConfirmDeliveryPopUpState();
}

class _ConfirmDeliveryPopUpState extends State<ConfirmDeliveryPopUp> {
  @override
