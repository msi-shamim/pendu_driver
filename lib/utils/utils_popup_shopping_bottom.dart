...
class ShoppingBottomPopupUtils extends StatefulWidget {
  @override
  _ShoppingBottomPopupUtilsState createState() =>
      _ShoppingBottomPopupUtilsState();
}

class _ShoppingBottomPopupUtilsState extends State<ShoppingBottomPopupUtils> {
