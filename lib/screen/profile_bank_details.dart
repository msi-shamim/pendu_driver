...
class ProfileBankDatails extends StatefulWidget {
  @override
  _ProfileBankDatailsState createState() => _ProfileBankDatailsState();
}

class _ProfileBankDatailsState extends State<ProfileBankDatails> {
  Widget _buildButton() {
    return SizedBox(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: PreferredSize(
          ...
          child: CommonAppBar(appBarTitle: 'Bank Details'),
        ),
