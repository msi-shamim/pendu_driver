...
class JobsConfirmedListPage extends StatefulWidget {
  @override
  _JobsConfirmedListPageState createState() => _JobsConfirmedListPageState();
}

class _JobsConfirmedListPageState extends State<JobsConfirmedListPage> {
