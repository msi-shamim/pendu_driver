...
class PenduChatSupportPage extends StatefulWidget {
  @override
  _PenduChatSupportPageState createState() => _PenduChatSupportPageState();
}

class _PenduChatSupportPageState extends State<PenduChatSupportPage> {
  Widget _buildAppBar() {
