...
class JobSearchFromMapBottomSheet extends StatefulWidget {
  @override
  _JobSearchFromMapBottomSheetState createState() =>
      _JobSearchFromMapBottomSheetState();
}

class _JobSearchFromMapBottomSheetState
    extends State<JobSearchFromMapBottomSheet> {
  double itemCost = 251;
  Color faddedColor = Pendu.color('90A0B2');

  static const _initialCameraPosition =
      CameraPosition(target: LatLng(-33.865143, 151.209900), zoom: 11.5);
  ...
  Widget _buildGoogleMap() {
    return GoogleMap(
      ...
      markers: {
        if (_taskMarker != null) _taskMarker,
      },
      // onLongPress: _showTaskMarkers,
    );
  }

//on long press add pickup marker
  void _showTaskMarkers() {
    setState(() {
      _taskMarker = Marker(
        markerId: const MarkerId('task'),
        infoWindow: const InfoWindow(title: 'Task Here'),
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => OfferSentPage()));
              },
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ReportProblemFormPage()));
                      },
                      child: Text(
                        'Report',
                        style: TextStyle(color: Colors.white),
